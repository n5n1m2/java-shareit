...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> bookItem(long userId, BookItemRequestDto dtoInput) {
        if (dtoInput == null) {
    ...
    public ResponseEntity<Object> updateBooking(Integer id, Boolean approved, Integer userId) {
        return patch("/" + id + "?approved=" + approved, userId, null);
    }

    public ResponseEntity<Object> getMyBookings(Integer userId, BookingState state) {
